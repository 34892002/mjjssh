...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::vault::list_command_history,
            commands::vault::record_command_history,
            commands::vault::clear_command_history,
            ...
            commands::vault::list_proxies,
            commands::vault::create_proxy,
            commands::vault::update_proxy,
            commands::vault::delete_proxy,
            ...
            commands::sftp::get_remote_file_metadata,
            ...
            commands::sftp::discard_external_edit_session,
            commands::sftp::clear_external_edit_sessions,
